...
package org.quickstart.remoting.grizzly.echo;
...
public class ClientFilter extends BaseFilter {
    ...
    public NextAction handleRead(final FilterChainContext ctx) throws IOException {
        ...
        final InetSocketAddress serverAddress =  (InetSocketAddress) ctx.getAddress();
        
        System.out.println("Server echo: " + serverResponse + ",host=" + serverAddress.getHostString() + ",port=" + serverAddress.getPort());
